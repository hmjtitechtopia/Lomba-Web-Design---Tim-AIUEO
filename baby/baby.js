document.addEventListener("DOMContentLoaded", () => {
  ...
  const flowers = {
    "Baby Bodysuit":   { price: 20000, img: "../properti/custom/baby born 22.png" },
    "Baju Tidur Bunga":   { price: 40000, img: "../properti/custom/baby born 23.png" },
    "Bodysuit Bunga":  { price: 30000, img: "../properti/custom/baby born 24.png" },
    "Bodysuit Awan":    { price: 20000, img: "../properti/custom/baby born 25.png" },
    "Jumpsuit Bayi":    { price: 30000, img: "../properti/custom/baby born 26.png" },
    "Kaos Kaki Pink":{ price: 10000, img: "../properti/custom/baby born 18.png" },
    "Kaos Kaki":  { price: 10000, img: "../properti/custom/baby born 21.png" },
    "Kaos Kaki Mix":   { price: 12000, img: "../properti/custom/baby born 15.png" },
    "Sarung Tangan 1":     { price: 10000, img: "../properti/custom/baby born 11.png" },
    "Sarung Tangan 2":    { price: 10000, img: "../properti/custom/baby born 13.png" },
    "Pita Putih":{ price: 5000, img: "../properti/custom/pita 1.png" },
    "Pita Pink":{ price: 5000, img: "../properti/custom/pita 2.png" },
    "Keranjang Coklat":{ price: 20000, img: "../properti/custom/keranjang coklat.png" },
    "Keranjang Putih":{ price: 20000, img: "../properti/custom/keranjang putih.png" },
  };

  const checkboxes = document.querySelectorAll('input[name="flowers"]');
  const qtyInput = document.getElementById("flower-qty");
  const priceEl = document.getElementById("price");
  const subtotalEl = document.getElementById("subtotal");

  let selectedFlowers = ["Baby Bodysuit"];
  let qty = 1;
